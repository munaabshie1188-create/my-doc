...
const config = {
  ...
  tagline: 'Clinical Data Management & PaaS Architecture Documentation',
  ...
  organizationName: 'munaabshie1188-create', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Supabase Clinical Docs',
        logo: {
          alt: 'Supabase Clinical Data Portal Logo',
          src: 'img/logo.svg',
        },
        items: [
          {
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Muna Abdullahi. Built with Docusaurus.`,
      },
      prism: {
